...
\defineAuthor{firstname4}{Andre P.}

\defineAuthor{surname5}{Rianzares}
\defineAuthor{firstname5}{Max V.}

\newcommand{\documentTitle}{Microcontroller based eye tracker using RGB-D camera for detection of driver awareness} % put tilde (~) between words to indicate non-breaking adjacent words
...
\begin{SingleSpace}
  ...
  %Roy, pakitanggal ng comment kung ayaw lumabas yung references tapos compile, after mo icompile ibalik mo sa comment tapos compile ulit medyo may bug kasi eh
