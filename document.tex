...
\defineAuthor{firstname4}{Andre [insert MI]}

\defineAuthor{surname5}{Rianzares}
\defineAuthor{firstname5}{Max V.}

\newcommand{\documentTitle}{INSERT TITLE HERE
} % put tilde (~) between words to indicate non-breaking adjacent words
...
\begin{SingleSpace}
 ...
 \begin{comment}
\cite{barsukov2013battery}
\cite{bouzid2017boosted}
\cite{corves2016new}
\cite{jashnani2013sizing}
\cite{kalyani2018energy}
\cite{li2014circuits}
\cite{marques2017advanced}
\cite{mostafa2017wireless}
\cite{muharam2017design}
\cite{rajendran2018development}
\cite{shaheed2015flying}
\cite{shiau2009design}
\cite{shiau2009design}
\cite{sydorenko2012flying}
\cite{wei2017system}
\cite{zhang2018experimental}
\end{comment}
	%\vfill
